class Z_SMERP_CL_PM_DTSYSCOND_DO definition
  public
  inheriting from /SYCLO/CL_CORE_DT_HANDLER
  create public .

public section.
*"* public components of class Z_SMERP_CL_PM_DTSYSCOND_DO
*"* do not include other source files here!!!
  ...
  methods /SYCLO/IF_CORE_FILTER_SERV~GET_DATA_FILTER_LIST
    redefinition .
*"* protected components of class Z_SMERP_CL_PM_DTSYSCOND_DO
*"* do not include other source files here!!!
protected section.

  methods GET_DATA_TABLE
    redefinition .
*"* private components of class Z_SMERP_CL_PM_DTSYSCOND_DO
*"* do not include other source files here!!!
private section.
ENDCLASS.
...
CLASS Z_SMERP_CL_PM_DTSYSCOND_DO IMPLEMENTATION.
...
*********************************************************************
  TRY.
      ...
      SELECT t357m~anlzu as key
             t357m_t~anlzux AS value
        FROM t357m LEFT JOIN t357m_t ON t357m~anlzu = t357m_t~anlzu AND
                                        t357m_t~spras = sy-langu
